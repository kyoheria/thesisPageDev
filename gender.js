...
function darwGendef(){
  ...
  textSize(20);
  fill(colorPalet[0]);
  text("male", 50,windowHeight/2+50*0);
  fill(colorPalet[1]);
  text("female", 50,windowHeight/2+50*1);
  fill(colorPalet[2]);
  text("genderfluid", 50,windowHeight/2+50*2);
  fill(colorPalet[3]);
  text("agender", 50,windowHeight/2+50*3);
  fill(colorPalet[4]);
  text("non-binary", 50,windowHeight/2+50*4);
  fill(colorPalet[5]);
  text("genderqueer", 50,windowHeight/2+50*5);
  fill(colorPalet[6]);
  text("trans", 50,windowHeight/2+50*6);
